!function () {
    ...
    function (e) {
        ...
        e.picturefill = function () {
            for (var t = e.document.getElementsByTagName("span"), n = 0, r = t.length; r > n; n++)
                if (null !== t[n].getAttribute("data-picture")) {
                    for (var i = t[n].getElementsByTagName("span"), o = [], a = 0, s = i.length; s > a; a++) {
                        var l = i[a].getAttribute("data-media");
                        (!l || e.matchMedia && e.matchMedia(l).matches) && o.push(i[a])
                    }
                    var u = t[n].getElementsByTagName("img")[0];
                    if (o.length) {
                        var c = o.pop();
                        if (u && "NOSCRIPT" !== u.parentNode.nodeName) {
                            if (c === u.parentNode) continue
                        } else u = e.document.createElement("img"), u.alt = t[n].getAttribute("data-alt");
                        u.src = c.getAttribute("data-src"), c.appendChild(u), u.removeAttribute("width"), u.removeAttribute("height")
                    } else u && u.parentNode.removeChild(u)
                }
    ...
    function c(e, t, n, r) {
        if (ot.acceptData(e)) {
            var i, o, a = ot.expando,
                ...
                l = s ? ot.cache : e,
                u = s ? e[a] : e[a] && a;
            if (u && l[u] && (r || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = Y.pop() || ot.guid++ : a), l[u] || (l[u] = s ? {} : {
                toJSON: ot.noop
    ...
    function m(e, t) {
        ...
        if (!o)
            for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || ot.nodeName(r, t) ? o.push(r) : ot.merge(o, m(r, t));
    ...
    function A(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = ot._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Dt(r) && (o[a] = ot._data(r, "olddisplay", N(r.nodeName)))) : o[a] || (i = Dt(r), (n && "none" !== n || !i) && ot._data(r, "olddisplay", i ? n : ot.css(r, "display"))));
    ...
    function O(e, t, n) {
        ...
        for (r in t)
            if (i = t[r], vn.exec(i)) {
                ...
                f[r] = g && g[r] || ot.style(e, r)
            }
        if (!ot.isEmptyObject(f)) {
            g ? "hidden" in g && (h = g.hidden) : g = ot._data(e, "fxshow", {}), o && (g.hidden = !h), h ? ot(e).show() : d.done(function () {
                ot(e).hide()
            }), d.done(function () {
                var t;
    ...
    function $(e, t, n) {
        var r, i, o = 0,
            ...
            l = function () {
                if (i) return !1;
                for (var t = gn || M(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
    ...
    var ct = function (e) {
        function t(e, t, n, r) {
            ...
            if (q && !r) {
                ...
                if (C.qsa && (!_ || !_.test(e))) {
                    if (h = d = B, g = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[B] && (i = v(i)), o && !o[B] && (o = v(o, a)), r(function (r, a, s, l) {
                var u, c, d, f = [],
                    ...
                    y = n ? o || (r ? e : h || i) ? [] : a : v;
                if (n && n(v, y, s, l), i)
                    for (u = m(y, p), i(u, [], s, l), c = u.length; c--;)(d = u[c]) && (y[p[c]] = !(v[p[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
                ...
                } else y = m(y === a ? y.splice(h, y.length) : y), o ? o(null, a, y, l) : Z.apply(a, y)
            })
        }
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = E.relative[e[0].type], a = o || E.relative[" "], s = o ? 1 : 0, l = h(function (e) {
                ...
                if (n = E.relative[e[s].type]) c = [h(g(c), n)];
                else {
                    if (n = E.filter[e[s].type].apply(null, e[s].matches), n[B]) {
        ...
        function w(e, t, n, r) {
            ...
            if (!r && 1 === u.length) {
                ...
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !E.relative[s = a.type]);)
                    if ((l = E.find[s]) && (r = l(a.matches[0].replace(wt, Tt), bt.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && p(o), !e) return Z.apply(n, r), n;
                        break
                    }
            }
            return S(e, u)(r, t, !q, n, bt.test(e) && c(t.parentNode) || t), n
        }

        var T, C, E, N, k, S, A, D, j, L, H, M, q, _, O, F, $, B = "sizzle" + -new Date,
            P = e.document,
            R = 0,
            W = 0,
            z = n(),
        ...
        C = t.support = {}, k = t.isXML = function (e) {
            ...
            var t, n = e ? e.ownerDocument || e : P,
                r = n.defaultView;
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, M = n.documentElement, q = !k(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
                L()
                ...
                return M.appendChild(e).id = B, !n.getElementsByName || !n.getElementsByName(B).length
                ...
                }, O = [], _ = [], (C.qsa = vt.test(n.querySelectorAll)) && (i(function (e) {
            ...
            })), (C.matchesSelector = vt.test(F = M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && i(function (e) {
                C.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), O.push("!=", st)
            }), _ = _.length && new RegExp(_.join("|")), O = O.length && new RegExp(O.join("|")), t = vt.test(M.compareDocumentPosition), $ = t || vt.test(M.contains) ? function (e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !C.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === P && $(P, e) ? -1 : t === n || t.ownerDocument === P && $(P, t) ? 1 : D ? tt.call(D, e) - tt.call(D, t) : 0 : 4 & r ? -1 : 1)
            } : function (e, t) {
                if (e === t) return j = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== H && L(e), n = n.replace(dt, "='$1']"), !(!C.matchesSelector || !q || O && O.test(n) || _ && _.test(n))) try {
                var r = F.call(e, n);
            ...
            var n = E.attrHandle[t.toLowerCase()],
                r = n && J.call(E.attrHandle, t.toLowerCase()) ? n(e, t, !q) : void 0;
            ...
            filter: {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (c = m[B] || (m[B] = {}), u = c[e] || [], p = u[0] === R && u[1], f = u[0] === R && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();)
                                ...
                                for (;
                                    (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[B] || (d[B] = {}))[e] = [R, f]), d !== t)););
                ...
                PSEUDO: function (e, n) {
                    ...
                    return o[B] ? o(n) : o.length > 1 ? (i = [e, e, "", n], E.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function (e, t) {
        ...
        return d.prototype = E.filters = E.pseudos, E.setFilters = new d, S = t.compile = function (e, t) {
            ...
            return o
        }, C.sortStable = B.split("").sort(U).join("") === B, C.detectDuplicates = !!j, L(), C.sortDetached = i(function (e) {
    ...
    var ht, gt = e.document,
        ...
        vt = ot.fn.init = function (e, t) {
            ...
            if ("string" == typeof e) {
                ...
                if (n[1]) {
                    if (t = t instanceof ot ? t[0] : t, ot.merge(this, ot.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : gt, !0)), ft.test(n[1]) && ot.isPlainObject(t))
    ...
    ot.fn.ready = function (e) {
        ...
        if (!Tt)
            if (Tt = ot.Deferred(), "complete" === gt.readyState) setTimeout(ot.ready);
    ...
    ot.event = {
        ...
        add: function (e, t, n, r, i) {
            var o, a, s, l, u, c, d, f, p, h, g, m = ot._data(e);
            if (m) {
                for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = ot.guid++), (a = m.events) || (a = m.events = {}), (c = m.handle) || (c = m.handle = function (e) {
                    return typeof ot === Et || e && ot.event.triggered === e.type ? void 0 : ot.event.dispatch.apply(c.elem, arguments)
                }, c.elem = e), t = (t || "").match(xt) || [""], s = t.length; s--;) o = Ot.exec(t[s]) || [], p = g = o[1], h = (o[2] || "").split(".").sort(), p && (u = ot.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = ot.event.special[p] || {}, d = ot.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function (e, t, n, r, i) {
            var o, a, s, l, u, c, d, f, p, h, g, m = ot.hasData(e) && ot._data(e);
            if (m && (c = m.events)) {
                for (t = (t || "").match(xt) || [""], u = t.length; u--;)
                    if (s = Ot.exec(t[u]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = ot.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, f = c[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = f.length; o--;) a = f[o], !i && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (f.splice(o, 1), a.selector && f.delegateCount--, d.remove && d.remove.call(e, a));
                        l && !f.length && (d.teardown && d.teardown.call(e, h, m.handle) !== !1 || ot.removeEvent(e, p, m.handle), delete c[p])
                    } else
        ...
        fix: function (e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = qt.test(i) ? this.mouseHooks : Mt.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ot.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    Qt.optgroup = Qt.option, Qt.tbody = Qt.tfoot = Qt.colgroup = Qt.caption = Qt.thead, Qt.th = Qt.td, ot.extend({
        clone: function (e, t, n) {
            ...
            if (rt.html5Clone || ot.isXMLDoc(e) || !Bt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Kt.innerHTML = e.outerHTML, Kt.removeChild(o = Kt.firstChild)), !(rt.noCloneEvent && rt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ot.isXMLDoc(e)))
        ...
        buildFragment: function (e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = g(t), p = [], h = 0; d > h; h++)
                if (o = e[h], o || 0 === o)
                    if ("object" === ot.type(o)) ot.merge(p, o.nodeType ? [o] : o);
                        ...
                        for (s = s || f.appendChild(t.createElement("div")), l = (Wt.exec(o) || ["", ""])[1].toLowerCase(), c = Qt[l] || Qt._default, s.innerHTML = c[1] + o.replace(Rt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
                        if (!rt.leadingWhitespace && Pt.test(o) && p.push(t.createTextNode(Pt.exec(o)[0])), !rt.tbody)
            ...
            for (s && f.removeChild(s), rt.appendChecked || ot.grep(m(p, "input"), v), h = 0; o = p[h++];)
                if ((!r || -1 === ot.inArray(o, r)) && (a = ot.contains(o.ownerDocument, o), s = m(f.appendChild(o), "script"), a && w(s), n))
        ...
        remove: function (e, t) {
            for (var n, r = e ? ot.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || ot.cleanData(m(n)), n.parentNode && (t && ot.contains(n.ownerDocument, n) && w(m(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function () {
        ...
        html: function (e) {
            return jt(this, function (e) {
                ...
                if (!("string" != typeof e || Xt.test(e) || !rt.htmlSerialize && Bt.test(e) || !rt.leadingWhitespace && Pt.test(e) || Qt[(Wt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Rt, "<$1></$2>");
                    try {
                        for (; r > n; n++) t = this[n] || {}, 1 === t.nodeType && (ot.cleanData(m(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (i) {
                    }
                }
        ...
        domManip: function (e, t) {
            ...
            if (u && (s = ot.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                for (o = ot.map(m(s, "script"), b), i = o.length; u > l; l++) r = s, l !== d && (r = ot.clone(r, !0, !0), i && ot.merge(o, m(r, "script"))), t.call(this[l], r, l);
                if (i)
                    for (a = o[o.length - 1].ownerDocument, ot.map(o, x), l = 0; i > l; l++) r = o[l], Vt.test(r.type || "") && !ot._data(r, "globalEval") && ot.contains(a, r) && (r.src ? ot._evalUrl && ot._evalUrl(r.src) : ot.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Jt, "")));
                s = n = null
            }
            return this
        }
        ...
        ot.fn[e] = function (e) {
            for (var n, r = 0, i = [], o = ot(e), a = o.length - 1; a >= r; r++) n = r === a ? this : this.clone(!0), ot(o[r])[t](n), G.apply(i, n.get());
    ...
    e.getComputedStyle ? (tn = function (e) {
        ...
        function t() {
            ...
            r && (t = gt.createElement("div"), n = gt.createElement("div"), t.style.cssText = u, r.appendChild(t).appendChild(n), n.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;display:block;padding:1px;border:1px;width:4px;margin-top:1%;top:1%", ot.swap(r, null != r.style.zoom ? {
                zoom: 1
            } : {}, function () {
                i = 4 === n.offsetWidth
    ...
    ot.Animation = ot.extend($, {
        ...
        var e, t = ot.timers,
            n = 0;
        for (gn = ot.now(); n < t.length; n++) e = t[n], e() || t[n] !== e || t.splice(n--, 1);
    ...
    ot.parseJSON = function (t) {
        ...
        var n, r = null,
            i = ot.trim(t + "");
        return i && !ot.trim(i.replace(qn, function (e, t, i, o) {
    ...
    _n = zn.exec(On.toLowerCase()) || [], ot.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            function n(e, t, n, r) {
                var i, c, v, y, x, T = t;
                2 !== b && (b = 2, s && clearTimeout(s), u = void 0, a = r || "", w.readyState = e > 0 ? 4 : 0, i = e >= 200 && 300 > e || 304 === e, n && (y = W(d, w, n)), y = z(d, y, w, i), i ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (ot.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (ot.etag[o] = x)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, c = y.data, v = y.error, i = !v)) : (v = T, (e || !T) && (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", i ? h.resolveWith(f, [c, T, w]) : h.rejectWith(f, [w, T, v]), w.statusCode(m), m = void 0, l && p.trigger(i ? "ajaxSuccess" : "ajaxError", [w, d, i ? c : v]), g.fireWith(f, [w, T]), l && (p.trigger("ajaxComplete", [w, d]), --ot.active || ot.event.trigger("ajaxStop")))
            }
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || On) + "").replace(Fn, "").replace(Wn, _n[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ot.trim(d.dataType || "*").toLowerCase().match(xt) || [""], null == d.crossDomain && (r = zn.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === _n[1] && r[2] === _n[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (_n[3] || ("http:" === _n[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ot.param(d.data, d.traditional)), P(In, d, t, w), 2 === b) return w;
            l = d.global, l && 0 === ot.active++ && ot.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Rn.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (Mn.test(o) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = $n.test(o) ? o.replace($n, "$1_=" + Hn++) : o + (Mn.test(o) ? "&" : "?") + "_=" + Hn++)), d.ifModified && (ot.lastModified[o] && w.setRequestHeader("If-Modified-Since", ot.lastModified[o]), ot.etag[o] && w.setRequestHeader("If-None-Match", ot.etag[o])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Un + "; q=0.01" : "") : d.accepts["*"]);
    ...
    ot.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = ot.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(rr, "$1" + i) : t.jsonp !== !1 && (t.url += (Mn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    ot.offset = {
        ...
        offset: function (e) {
            ...
            var t, n, r = {
                ...
                i = this[0],
                o = i && i.ownerDocument;
            return o ? (t = o.documentElement, ot.contains(t, i) ? (typeof i.getBoundingClientRect !== Et && (r = i.getBoundingClientRect()), n = V(o), {
    ...
    function (e, t) {
        ...
        var n = function (n) {
            return n.each(function () {
                function n(e) {
                    t(e.target).trigger("tap", [e, t(e.target).attr("href")]), e.stopImmediatePropagation()
                }

                function r(e) {
                    var t = e.originalEvent || e,
                        n = t.touches || t.targetTouches;
                    return n ? [n[0].pageX, n[0].pageY] : null
                }

                function i(e) {
                    if (e.touches && e.touches.length > 1 || e.targetTouches && e.targetTouches.length > 1) return !1;
                    var t = r(e);
                    u = t[0], l = t[1]
                }
                ...
                function o(e) {
                    if (!c) {
                        var t = r(e);
                        t && (Math.abs(l - t[1]) > f || Math.abs(u - t[0]) > f) && (c = !0)
                    }
                }
                ...
                function a(t) {
                    if (clearTimeout(s), s = setTimeout(function () {
                            e.tapHandling = !1, c = !1
                        }, 1e3), !t.ctrlKey && !t.metaKey) {
                        if (t.preventDefault(), c || e.tapHandling && e.tapHandling !== t.type) return void(c = !1);
                        e.tapHandling = t.type, n(t)
                    }
                }

                var s, l, u, c, d = t(this),
                    f = 10;
                d.bind("touchstart MSPointerDown", i).bind("touchmove MSPointerMove", o).bind("touchend MSPointerUp", a).bind("click", a)
            })
        };
        if (t.event && t.event.special) t.event.special.tap = {
            add: function () {
                n(t(this), !0)
            },
            remove: function () {
            ...
            t.fn.bind = function (e) {
                return /(^| )tap( |$)/.test(e) && n(this), r.apply(this, arguments)
            }
        }
    }(this, jQuery), $(function () {
    $("span.js-inline-svg").each(function () {
        var e = $(this).data().imgAlt,
            t = Modernizr.inlinesvg ? $(this).data().svgSrc : $(this).data().svgSrc.replace("svg", "png"),
            n = $(this).attr("class");
        $(this).hide(), $(this).after('<img class="' + n + '" src="' + t + '" alt="' + e + '">'), $(this).remove()
    })
}),
    function () {
        "use strict";
        var e = function (e) {
            var t = e.data();
            return this.slideTarget = t.slideTarget, this.toggleTarget = t.toggleTarget, this.focus = t.toggleFocus, this.toggleRemote = t.toggleRemote, this.toggleSelf = 0 != t.toggleSelf, this.toggleClass = t.toggleClass.replace(".", ""), this.shouldTerminateEvent = 1 != t.terminateEvent, this.find = $.proxy(void 0 === this.toggleRemote ? e.find : $, e), this.toggle = $.proxy(this.toggle, this), this.$el = e, this.find(t.toggleTrigger).off("click").on("click", this.toggle), this
        };
        e.prototype.toggle = function () {
            var e = this.find(this.toggleTarget);
            return e.toggleClass(this.toggleClass), this.toggleSelf && this.$el.toggleClass(this.toggleClass), this.slideTarget && this.find(this.slideTarget).slideToggle(600, function () {
            }), this.focus && e.hasClass(this.toggleClass) && this.find(this.focus).focus(), this.shouldTerminateEvent
        }, window.Toggler = e
    }(window);
var AlertSwitcher = function (e) {
    var t = e.data();
    this.switchTrigger = t.alertSwitchTrigger.replace(".", ""), this.items = e.find("[data-alert-item]"), this.count = this.items.length, this.index = 0, this.motion = 300, this.$el = e, this.next = $.proxy(this.next, this), this.getCurrent = $.proxy(this.getCurrent, this), e.find(t.alertSwitchTrigger).on("click", this.next)
};
AlertSwitcher.prototype.toggleCurrent = function () {
    this.items.eq(this.index).toggle()
}, AlertSwitcher.prototype.next = function () {
    return this.toggleCurrent(), ++this.index >= this.count && (this.index = 0), this.toggleCurrent(), this
}, $(function () {
    var e = $("[data-alert-switcher]");
    e.length && e.each(function () {
        new AlertSwitcher(e)
    })
}), $(function () {
    function e() {
        r || (r = t(), r && clearInterval(n))
    }
    ...
    function t() {
        var e = function (e) {
            ...
            t = e("q") || "Search",
            n = $("input.gsc-input");
        return n.val() || n.attr("placeholder", t), n.attr("placeholder") ? !0 : !1
    }

    var n = !1,
        r = !1;
    Modernizr.placeholder && (n = setInterval(e, 1e3))
}), $(function () {
